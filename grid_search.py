...
initial_membrane_time_constant_range = (830/1000, 890/1000)  # 7: (400/1000, 800/1000), 8: (650/1000, 1000/1000)

output_time_window_range = (74, 82)  # max. 768, 7: (60, 100), 8: (60, 80)
threshold_voltage_range = (1.275, 1.325)  # 7: (1.15, 1.37), 8: (1.15, 1.30)
expected_firing_rate_range = (0.107, 0.111)  # 7: (0.07, 0.13), 8: (0.08, 0.12)

gradient_scaling_factor = 0.3

learning_rate_range = (6.2e-4, 7.8e-4)  # 7: (1e-3, 1.5e-3), 8: (1e-3, 1.3e-3), 9: (7e-4, 1.3e-3)
weight_decay_rate_range = (4.6e-5, 5.6e-5)  # 7: (2e-5, 1e-4), 8: (2e-5, 7e-5)
...
network_dropout_rate_range = (0.345, 0.38)  # 7: (0.28, 0.4), 8: (0.3, 0.4)
input_dropout_rate_range = (0.745, 0.775)  # 7: (0.3, 0.4), 8: (0.6, 0.9)
gradient_clipping_value_range = (444, 485)  # 7: (300, 700), 8: (350, 500)
