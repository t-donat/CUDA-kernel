...
initial_membrane_time_constant_range = (780/1000, 900/1000)  # 7: (400/1000, 800/1000), 8: (650/1000, 1000/1000)

output_time_window_range = (70, 78)  # max. 768, 7: (60, 100), 8: (60, 80)
threshold_voltage_range = (1.15, 1.23)  # 7: (1.15, 1.37), 8: (1.15, 1.30)
...
firing_rate_lambda_range = (1_200.0, 1_400.0)  # 7: (1_100.0, 1_500.0), 8: (1_300.0, 1_600.0)
time_constant_lambda_range = (45.0, 55.0)  # 7: (10.0, 50.0), 8: (30.0, 60.0)

network_dropout_rate_range = (0.35, 0.37)  # 7: (0.28, 0.4), 8: (0.3, 0.4)
input_dropout_rate_range = (0.75, 0.85)  # 7: (0.3, 0.4), 8: (0.6, 0.9)
